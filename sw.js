const CACHE='life-compass-ai-os-v2.8.1';
const CACHE_PREFIX='life-compass-ai-os-';
const HOME_URL=new URL('./index.html',self.location.href).href;
const ASSETS=['./index.html','./styles.css?v=2.8.1','./manifest.webmanifest?v=2.8.1','./assets/icon.svg','./src/app.js?v=2.8.1','./src/model.js','./src/storage.js','./src/migration.js','./src/ai.js','./src/integrations.js','./src/duplicates.js'];
